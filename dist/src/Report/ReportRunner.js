...
class ReportRunner {
    ...
    runReporters(site, results) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.reporters.length; i++) {
                ...
                const reporterData = yield reporter.handle(site, results);
                if (reporterData) {
    ...
    runReport(rootUrl, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const auditResult = yield runner.createAudit(rootUrl, path, this.opts, this.config, this.port);
            this.logger.debug(`Report for ${path} completed`);
            auditResult.reporters = yield this.runReporters(site, auditResult);
            return auditResult;
        });
    }
}
